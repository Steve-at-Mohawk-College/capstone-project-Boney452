      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-4 sm:py-8">
        ...
        <div className="mb-4 sm:mb-6 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-0">
          ...
          <button
            ...
            className="btn btn-primary w-full sm:w-auto text-sm sm:text-base px-4 sm:px-6"
          >
            + Add User
          </button>
        </div>
        ...
        <div className="mb-4 sm:mb-6 flex gap-3 sm:gap-4 flex-col sm:flex-row">
          <div className="flex-1 relative">
            <input
              ...
              className="w-full px-3 sm:px-4 py-2 sm:py-2.5 pl-9 sm:pl-10 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm"
              style={{
          ...
          <select
            ...
            className="px-3 sm:px-4 py-2 sm:py-2.5 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 text-sm sm:w-auto w-full"
            style={{
              backgroundColor: "white",
              border: "1px solid #E5E7EB",
              borderRadius: "8px",

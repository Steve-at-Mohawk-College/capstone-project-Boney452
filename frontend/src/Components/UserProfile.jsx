...
function UserProfile({ userInfo, onSignOut, onBackToSearch, onProfileUpdate }) {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-start px-6 py-10 bg-transparent">
      {/* Header */}
      <div className="w-full max-w-4xl mb-8">
        <div className="flex items-center justify-between mb-6">
          <div className="flex items-center gap-4">
            ...
            <h1 className="header-xl">My Profile</h1>
          </div>
          <button 
            onClick={onSignOut}
        ...
        {/* User Info Card */}
        <div className="glass p-6 rounded-lg border border-slate-200/70 mb-6">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-16 h-16 rounded-full bg-blue-600 flex items-center justify-center text-white text-2xl font-bold">
              {userInfo.UserName ? userInfo.UserName.charAt(0).toUpperCase() : "U"}
            </div>
            <div>
              <h2 className="text-2xl font-bold text-slate-900">{userInfo.UserName}</h2>
              <p className="text-slate-600">{userInfo.UserEmail}</p>
              {userInfo.IsAdmin && (
        ...
        {activeTab === "username" && (
          <div className="glass p-6 rounded-lg border border-slate-200/70">
        ...
        {/* Delete Account Form */}
        {activeTab === "delete" && (
          <div className="glass p-6 rounded-lg border border-red-200/70 bg-red-50/30">
            <div className="mb-4">
